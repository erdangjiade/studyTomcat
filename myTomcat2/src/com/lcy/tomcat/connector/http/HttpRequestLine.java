...
final class HttpRequestLine {
	...
	public String toString() {
		return "HttpRequestLine [method=" + Arrays.toString(method)
				+ ", methodEnd=" + methodEnd + ", uri=" + Arrays.toString(uri)
				+ ", uriEnd=" + uriEnd + ", protocol="
				+ Arrays.toString(protocol) + ", protocolEnd=" + protocolEnd
				+ "]";
	}
