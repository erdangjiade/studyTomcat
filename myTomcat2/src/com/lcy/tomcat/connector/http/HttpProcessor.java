...
import com.lcy.tomcat.ServletProcessor;
import com.lcy.tomcat.StaticResourceProcessor;
...
public class HttpProcessor {
	...
	private HttpResponse response;
	 ...
	 /**
	  ...
	  protected StringManager sm =
	    StringManager.getManager("com.lcy.tomcat.connector.http");
	  
	
	public HttpProcessor(HttpConnector hc){
		this.httpConnector = hc;
	}
	...
	public void process(Socket socket) {
		...
		try {
			...
			response.setHeader("Server", "Lcy Servlet Container");
